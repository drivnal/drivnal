define([
  ...
  'use strict';
  var MIME_TYPES = [
    {match: 'applescript', brush: 'applescript'},
    {match: 'as3', brush: 'actionscript3'},
    {match: 'actionscript', brush: 'actionscript3'},
    {match: 'bash', brush: 'bash'},
    {match: 'shell', brush: 'shell'},
    {match: 'coldfusion', brush: 'coldfusion'},
    {match: 'csharp', brush: 'csharp'},
    {match: 'delphi', brush: 'delphi'},
    {match: 'haxe', brush: 'haxe'},
    {match: 'pas', brush: 'pascal'},
    {match: 'pascal', brush: 'pascal'},
    {match: 'diff', brush: 'diff'},
    {match: 'patch', brush: 'patch'},
    {match: 'erlang', brush: 'erlang'},
    {match: 'groovy', brush: 'groovy'},
    {match: 'jscript', brush: 'javascript'},
    {match: 'javascript', brush: 'javascript'},
    {match: 'javafx', brush: 'javafx'},
    {match: 'plain', brush: 'plain'},
    {match: 'powershell', brush: 'powershell'},
    {match: 'python', brush: 'python'},
    {match: 'rails', brush: 'ruby'},
    {match: 'ruby', brush: 'ruby'},
    {match: 'scala', brush: 'scala'},
    {match: 'sql', brush: 'sql'},
    {match: 'sass', brush: 'sass'},
    {match: 'scss', brush: 'sass'},
    {match: 'vb', brush: 'vb'},
    {match: 'xml', brush: 'xml'},
    {match: 'xhtml', brush: 'xhtml'},
    {match: 'xslt', brush: 'xslt'},
    {match: 'html', brush: 'html'},
    {match: 'java', brush: 'java'},
    {match: 'perl', brush: 'perl'},
    {match: 'typescript', brush: 'typescript'},
    {match: 'jfx', brush: 'jfx'},
    {match: 'php', brush: 'php'},
    {match: 'cpp', brush: 'cpp'},
    {match: 'css', brush: 'css'},
